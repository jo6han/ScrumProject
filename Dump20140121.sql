CREATE DATABASE  IF NOT EXISTS `floggit` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `floggit`;
-- MySQL dump 10.13  Distrib 5.6.13, for osx10.6 (i386)
--
-- Host: 127.0.0.1    Database: floggit
-- ------------------------------------------------------
...
INSERT INTO `categories` VALUES (1,'Books',27),(2,'Computing',58),(3,'Toys',62),(4,'Gardening',63),(5,'Electronics',58),(6,'Clothes',63),(7,'Mens',63),(8,'Womens',63),(9,'Children',63),(10,'Sports & outdoors',71),(11,'Films',27);
/*!40000 ALTER TABLE `categories` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Temporary table structure for view `categories_responsible`
--

DROP TABLE IF EXISTS `categories_responsible`;
/*!50001 DROP VIEW IF EXISTS `categories_responsible`*/;
SET @saved_cs_client     = @@character_set_client;
SET character_set_client = utf8;
/*!50001 CREATE TABLE `categories_responsible` (
  `category` tinyint NOT NULL,
  `Staff_responsible` tinyint NOT NULL
) ENGINE=MyISAM */;
...
--
-- Final view structure for view `categories_responsible`
--

/*!50001 DROP TABLE IF EXISTS `categories_responsible`*/;
/*!50001 DROP VIEW IF EXISTS `categories_responsible`*/;
...
/*!50001 VIEW `categories_responsible` AS select `categories`.`category` AS `category`,concat(`staff`.`firstname`,' ',`staff`.`surname`) AS `Staff_responsible` from (`staff` join `categories` on((`staff`.`id` = `categories`.`staff_id`))) */;
...
-- Dump completed on 2014-01-21 13:09:39
